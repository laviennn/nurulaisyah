...
// .wrangler/tmp/pages-0dMoY3/bundledWorker-0.0718038013188298.mjs
  ...
  function be(e, t) {
    ...
    for (var a = {}, s = t || {}, n = s.decode || Se, i = 0; i < e.length; ) {
      ...
      if (a[c] === void 0) {
        ...
        d.charCodeAt(0) === 34 && (d = d.slice(1, -1)), a[c] = Te(d, n);
      }
      i = o + 1;
    }
    return a;
...
__name2(xe, "xe");
async function W(e) {
  let t = `./__next-on-pages-dist__/cache/${e}.js`, a = await T(t);
...
function Re() {
  ...
  globalThis.fetch = async (...t) => {
    let a = new Request(...t), s = await _e(a);
...
async function _e(e) {
  if (e.url.startsWith("blob:")) try {
    let a = `./__next-on-pages-dist__/assets/${new URL(e.url).pathname}.bin`, s = (await T(a)).default, n = { async arrayBuffer() {
      return s;
    }, get body() {
...
async function ee(e, t, a, s) {
  let n = new N(t.routes, a, e, s, t.wildcard), i = await te(n);
  return Ee(e, i, a);
}
__name(ee, "ee");
__name2(ee, "ee");
...
// .wrangler/tmp/pages-0dMoY3/v2nxj0an6y.js
...
// .wrangler/tmp/bundle-z6atth/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-z6atth/middleware-loader.entry.ts
